...
public interface JavaGenerator extends Generator {
     ...
     *
     * <p>This method retrieves the content of a class that was previously
     * generated by calling {@link Generator#generate}.</p>
     *
     ...
     *
     * <p>The order of class names matches the generation order,
     * typically Request classes followed by Response classes.</p>
     *
     * @return a list of generated class names (never null, may be empty)
     */
